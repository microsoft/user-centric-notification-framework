...
using Notification.Function.SendReminders;
using Notification.Function.SendReminders.Helpers;
using Notification.Function.SendReminders.Interface;

[assembly: FunctionsStartup(typeof(SendRemindersStartup))]

namespace Notification.Function.SendReminders;

public class SendRemindersStartup : FunctionsStartup
{
